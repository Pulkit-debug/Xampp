...
= 1.0.5 =
* Header contact detail icons removed in default.

= 1.0.4 =
* Default customizer values removed.
* Getting started admin notification changed to core design patterns.
...
= 1.1.1 =
* This version fixed style issues.

= 1.1.0 =
* This version fixed style issues.

= 1.0.9 =
* This version updated block editor style.

= 1.0.8 =
* This version fixed style issues.

= 1.0.7 =
* This version fixed style issues and screenshot updated.

= 1.0.6 =
* This version fixed style issues.

= 1.0.5 =
* This version removed header contact detail icons in default.

= 1.0.4 =
* This version removed default customizer values and admin notification changed to core design patterns.

= 1.0.3 =
* This version added missing escaping and updated style.

= 1.0.2 =
* This version added theme info and updated style.

= 1.0.1 =
* This version fixed minor functional issues and updated style.
...
* screenshot.png
  https://stocksnap.io/photo/lake-mountains-VZBJUVPO25  [CC0]
* gutener-1920-550.jpg
  https://pxhere.com/en/photo/510089 [CC0]
* gutener-360-240.jpg
  https://pxhere.com/en/photo/1438039 [CC0]