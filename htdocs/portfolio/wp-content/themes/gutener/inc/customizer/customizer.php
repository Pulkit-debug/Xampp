...
function gutener_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'  => 'notification_bar_options',
		'default'  => esc_html__( 'This is your default notification bar which you can use to announce a sale or discount.', 'gutener' ),
		'active_callback' => array(
			array(
				'setting'  => 'disable_notification_bar',
				'operator' => '==',
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'  => 'notification_bar_options',
		'default'  => esc_html__( 'View More', 'gutener' ),
		'active_callback' => array(
			array(
				'setting'  => 'disable_notification_bar',
				'operator' => '==',
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'      => 'contact_detail_options',
		'default'      => esc_html__( '+ 1987 123456', 'gutener' ),
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'      => 'contact_detail_options',
		'default'      => esc_html__( 'yourmail@email.com', 'gutener' ),
		'active_callback' => array(
			array(
				'setting'  => 'disable_contact_detail',
				'operator' => '==',
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'      => 'contact_detail_options',
		'default'      => esc_html__( 'Rock Street, San Francisco, California', 'gutener' ),
		'active_callback' => array(
			array(
				'setting'  => 'disable_contact_detail',
				'operator' => '==',
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'     => 'single_post_options',
		'default'     => esc_html__( 'Related Posts', 'gutener' ),
		'active_callback' => array(
			array(
...
', 'gutener' ),
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'     => 'highlight_posts_options',
		'default'     => esc_html__( 'Highlighted Posts', 'gutener' ),
	) );
	...
	Kirki::add_field( 'gutener', array(
		...
		'section'     => 'feature_posts_options',
		'default'     => esc_html__( 'Featured Posts', 'gutener' ),
	) );
