	...
	if( !get_theme_mod( 'disable_notification_bar', true ) ){ ?>
		<div class="notification-bar <?php echo esc_html( $sticky_class ); ?>">
			<header class="notification-content">
				<span><?php echo esc_html(get_theme_mod( 'notification_bar_title', 'This is your default notification bar which you can use to announce a sale or discount.' ));?></span>
			</header>
			<div class="button-container">
				...
				<?php echo esc_html(get_theme_mod( 'notification_bar_button_text', 'View More' ));?>
			</a>
			</div>
		</div>
	<?php }
